...
/* PowerFox: the 10.6 SDK expands nil to __DARWIN_NULL (__null), which makes
   C++ smart-pointer assignments ambiguous. Modern SDKs define nil as
   nullptr; do the same here, in C++ only. */
#ifdef __cplusplus
#undef nil
#define nil nullptr
#endif
